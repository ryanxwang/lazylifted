...
cmd="./$planner_bin $domain_dir/domain.pddl $domain_dir/$instance.pddl -o $plan_file --time-limit 30min --memory-limit 8000 --model trained_models/$model_type-$model-$domain.model $subcommand --heuristic wl"
